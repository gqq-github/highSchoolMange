...
public class StudentMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_mian);
    ...
    public void  goOtherIntent (int pos) {
        switch (pos) {
            ...
            case 0 :
                //我的课程
                nextIntent(ShowStudentCourseActivity.class);
                break;

            case 1 :
                // 学生选课中心
                nextIntent(StudentSelectCourseActivity.class);
                break;
            case 2 :
                //提交作业
                nextIntent(StudentSendHomeWorkActivity.class);
                break;

            case 3 :
                nextIntent(StudentSeeHomework.class);
                break;

            case 4 :
                nextIntent(ShowStudentPersonalInfo.class);
                break;
            case 5 :
                // 课表管理
                nextIntent(StudentCourseTableActivity.class);
                break;
    ...
    public void loadData () {
        ...
        iconMyAdapter.doGetRequest(null, new ResponseJsonHandle() {
            ...
            protected void onSuccess(JSONObject data) throws JSONException {
                ...
                nextIntent(StudentInfoActivity.class);
            }
        });
    }
    public void doExit ()
